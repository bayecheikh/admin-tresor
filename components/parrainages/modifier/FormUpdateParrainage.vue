  ...
  export default {
    ...
    methods: {
      getDetail(id){
        ...
        .then(async (response) => {
          console.log("detail parrainage+++++++++ ",response)
            this.$store.dispatch('parrainages/getDetail',response?.data)
            this.model.id = response?.data?.id
            this.model.numero_cedeao = response?.data?.numero_cedeao
            this.model.prenom = response?.data?.prenom
            this.model.nom = response?.data?.nom
            this.model.date_naissance = response?.data?.date_naissance
            this.model.lieu_naissance = response?.data?.lieu_naissance
            this.model.taille = response?.data?.taille
            this.model.sexe = response?.data?.sexe
            this.model.numero_electeur = response?.data?.numero_electeur
            this.model.centre_vote = response?.data?.centre_vote
            this.model.bureau_vote = response?.data?.bureau_vote
            this.model.numero_cin = response?.data?.numero_cin
            this.model.telephone = response?.data?.telephone
            this.model.prenom_responsable = response?.data?.prenom_responsable
            this.model.nom_responsable = response?.data?.nom_responsable
            this.model.telephone_responsable = response?.data?.telephone_responsable
      ...
      submitForm () {
        ...
        if(validation && this.model.region!='' && this.model.departement!='' && this.model.commune!=''){
          this.loading = true
            this.$msasApi.post('/parrainages/'+this.model.id,formData)
            .then((res) => {
